...
// Account
    ...
    if ($_POST['product_sync_type_QBO'] == 'two_way') {
        ?>     <div id="pop_up_two-way" class="clientssummarybox" style=" width:600px !important; top: 24% !important; display: none;  z-index: 9999;  position: fixed !important;         padding: 10px !important;         line-height: 30px !important;          left: 25%;         position: absolute;         top: 100%;          float: left;           background-color: #ffffff;         border: 1px solid #ccc;         border: 1px solid rgba(0, 0, 0, 0.2);         -webkit-border-radius: 5px;         -moz-border-radius: 5px;         border-radius: 5px;         -webkit-box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);         -moz-box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);         box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);         -webkit-background-clip: padding-box;         -moz-background-clip: padding;         background-clip: padding-box; ">
            <a name="lnkViews" href=""><img style="height: 13px;float: right;"src="../wp-content/plugins/linksync/assets/images/linksync/cross_icon.png"></a><center><div id="showMessage"><center><h4>Your changes will require a full re-sync of product data.</h4></center>
...
?>" class="button button-primary" />
        ...
        <table class="form-table">
            <tbody>
                <tr valign="top">
                    <th  class="titledesc">Name/Title  <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="When enabled, Product titles will be kept in sync. In WooCommerce this is the product Name and in QBO it's the Product name. "  src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a> </th>
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-checkbox">
                        ...
                        <br> <br> <div style="margin-left: 40px;" ><span  class="ps_price_sub_options"> 
                                <b>WooCommerce price field to sync</b><a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Select which WooCommerce price field you want to sync with QBO sell price."  src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a>
                                <br><br>
                ...
                if (get_option('product_sync_type_QBO') == 'wc_to_QB') {
                    ...
                    <tr valign="top" class="account" style="display:<?php echo (get_option('product_sync_type_QBO') == 'QB_to_wc-way' ? 'none' : ''); ?>">
                        <th  class="titledesc">Asset Accounts fields  <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Accounts fields"  src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></th>
                        <td class="forminp forminp-checkbox">
                            <label style="display: inline-block;width: 25em;">
                ...
                if (!isset($accounts_expense['errorCode'])) {
                    ...
                    ?> <tr valign="top" class="account" style="display:<?php echo (get_option('product_sync_type_QBO') == 'QB_to_wc-way' ? 'none' : ''); ?>">
                        <th  class="titledesc">Expense Accounts fields  <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Accounts fields"  src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></th>
                        <td class="forminp forminp-checkbox">
                            <label style="display: inline-block;width: 25em;">
                            ...
                            if (!isset($accounts_revenue['errorCode'])) {
                                $accounts_db_revenue = get_option('ps_account_revenue');
                                    ?> <tr valign="top" class="account" style="display:<?php echo (get_option('product_sync_type_QBO') == 'QB_to_wc-way' ? 'none' : ''); ?>">
                        <th  class="titledesc">Revenue Accounts fields  <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Accounts fields"  src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></th>
                        <td class="forminp forminp-checkbox">
                            <label style="display: inline-block;width: 25em;">
                ...
                <?php if (in_array('woocommerce-brands/woocommerce-brands.php', apply_filters('active_plugins', get_option('active_plugins')))) {
                    ...
                    <tr valign="top" class="woocommerce_frontend_css_colors">
                        <th scope="row" class="titledesc">Brand<a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Enable this option to keep the Brand fields in sync between WooCommerce and QBO."  src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></th>
                        <td class="forminp">
                            <label style="display: inline-block;width: 25em;">
                ...
                <tr style="display:<?php echo (get_option('product_sync_type_QBO') == 'wc_to_QB' ? 'none' : ''); ?>" id="ps_pending" valign="top" class="woocommerce_frontend_css_colors">
                    <th scope="row" class="titledesc">Product Status <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-right: 10px" title="Enable this option if you want newly created product in QBO to be set to 'Pending Review' so that you can review and update new product before they are published in your WooCommerce store."  src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></th>
...
<?php update_option('post_product', 0); ?>
    ...
    function ajaxRequestForproduct(i,totalreq){ 
        var ajaxobj= linksynProduct_jquery.ajax({
            ...
            url: '../wp-content/plugins/linksync/includes/apps/qbo/sync_all_product_to_QBO.php',
