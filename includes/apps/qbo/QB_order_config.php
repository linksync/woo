                        ...
                        if ($info['version'] == 'QuickBooks Online Plus') {
                            ...
                            if (!isset($class['errorCode'])) {
                                if (isset($class) && !empty($class)) {
                                    ...
                                    ?> <tr valign="top">
                                        <th  class="titledesc">Class Tracking<a href="https://www.linksync.com/help/woocommerce"><img title="" style="margin-bottom: -4px;margin-left: 4px;" src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></th>
                                        <td class="forminp forminp-checkbox">
            ...
            if (!isset($location['errorCode'])) {
                if (isset($location) && !empty($location)) {
                    $location_db = get_option('QBO_locations');
                                                ?> <tr valign="top">
                                    <th  class="titledesc">Location Tracking<a href="https://www.linksync.com/help/woocommerce"><img title="" style="margin-bottom: -4px;margin-left: 4px;" src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></th>
                                    <td class="forminp forminp-checkbox">
                ...
                if (!isset($accounts['errorCode'])) {
                    if (isset($accounts) && !empty($accounts)) {
                        ...
                        ?> <tr valign="top">
                            <th  class="titledesc">Account fields<a href="https://www.linksync.com/help/woocommerce"><img title="" style="margin-bottom: -4px;margin-left: 4px;" src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></th>
                            <td class="forminp forminp-checkbox">
                ...
                <tr valign="top">
                    <th  class="titledesc">Tax mapping<a href="https://www.linksync.com/help/woocommerce"><img title="When syncing orders, both QBO and WooCommerce have their own tax configurations - use these Tax Mapping settings to 'map' the QBO taxes with those in your WooCommerce store." style="margin-bottom: -4px;margin-left: 4px;" src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></th>
...
#Check for the Payment
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-checkbox">
                <legend style="display: inline-block;width: 25em; ">  <input type="radio"  checked  <?php echo (get_option('QBO_to_wc_customer') == 'customer_data' ? 'checked' : ''); ?> value="customer_data" name="QBO_to_wc_customer" />Import Customer data<a href="https://www.linksync.com/help/woocommerce"><img title="Select this option if you'd like customer data, such as name, email address and shipping and billing address, to be included when importing orders from QBO."   style="margin-left: 4px;margin-bottom: -3px;"src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a></legend><br>
                <legend style="display: inline-block;width: 25em; "><input type="radio" <?php echo (get_option('QBO_to_wc_customer') == 'guest' ? 'checked' : ''); ?> value="guest" name="QBO_to_wc_customer" />Import as 'Guest'<a href="https://www.linksync.com/help/woocommerce"><img title="Select this option if you're not interested in including the customer information when importing orders from QBO." style="margin-left: 4px;margin-bottom: -3px;"  src="../wp-content/plugins/linksync/assets/images/linksync/help.png" height="16" width="16"></a><br/><br/>
                </legend>
                </td>
                </tr>
                </tbody>
