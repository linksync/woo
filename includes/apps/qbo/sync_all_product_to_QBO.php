...
//To free an array to use futher
        ...
        global $wpdb;
        $sql = "SELECT MIN(ID) AS first_post_id,MAX(ID) AS last_post_id ,COUNT(*) AS total_post_id FROM `" . $wpdb->prefix . "posts` WHERE post_type = 'product' AND post_status!='auto-draft'";
