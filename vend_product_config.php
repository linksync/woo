...
//            }
        ...
        if ($_POST['product_sync_type'] == 'two_way') {
            ?>     <div id="pop_up_two-way" class="clientssummarybox" style=" width:600px !important; top: 24% !important; display: none;  z-index: 9999;  position: fixed !important;         padding: 10px !important;         line-height: 30px !important;          left: 25%;         position: absolute;         top: 100%;          float: left;           background-color: #ffffff;         border: 1px solid #ccc;         border: 1px solid rgba(0, 0, 0, 0.2);         -webkit-border-radius: 5px;         -moz-border-radius: 5px;         border-radius: 5px;         -webkit-box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);         -moz-box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);         box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);         -webkit-background-clip: padding-box;         -moz-background-clip: padding;         background-clip: padding-box; ">
                <a name="lnkViews" href="javascript:;"><img style="height: 13px;float: right;"src="../wp-content/plugins/linksync/img/cross_icon.png"></a><center><div id="showMessage"><center><h4>Your changes will require a full re-sync of product data.</h4></center>
...
<form method="post" name="options">
    <fieldset>
        ...
        <p>
            <input <?php echo (get_option('product_sync_type') == 'two_way' ? 'checked' : ''); ?> type="radio" name="product_sync_type"  value="two_way"> Two-way <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;" title="Data is kept in sync between both systems, so changes to products and inventory can be made in either your WooCommerce or Vend store and those changes will be synced to the other store within a few moments."  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a>

            &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" <?php echo (get_option('product_sync_type') == 'vend_to_wc-way' ? 'checked' : ''); ?> name="product_sync_type" value="vend_to_wc-way"> Vend to WooCommerce <a  href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;" title="Vend is the 'master' when it comes to managing product and inventory, and product updates are one-way, from Vend to WooCommerce - product and inventory data does not update back to Vend from WooCommerce. You must enable Order Syncing from WooCommerce to Vend for this option to work correctly. " src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a>

            &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" <?php echo (get_option('product_sync_type') == 'wc_to_vend' ? 'checked' : ''); ?> name="product_sync_type" value="wc_to_vend"> WooCommerce to Vend <a  href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;" title="WooCommerce is the 'master' when it comes to managing product and inventory, and product updates are one-way, from WooCommerce to Vend - product and inventory data does not update back to WooCommerce to Vend. You must enable Order Syncing from Vend to WooCommerce for this option to work correctly. " src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a>

            &nbsp;&nbsp; &nbsp;&nbsp;  <input type="radio" <?php echo (get_option('product_sync_type') == 'disabled_sync' ? 'checked' : ''); ?> name="product_sync_type" value="disabled_sync" id="disabled_sync_id"> Disabled <a  href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;" title="Prevent any product syncing from taking place between your Vend and WooCommerce stores. " src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a>
        </p>

    </fieldset>
    <div style="display:<?php
if (get_option('product_sync_type') == 'disabled_sync') {
    echo "none";
}
?>"  id="product_sync_settig">
        ...
        <p>    <input type="submit" name="sync_reset_btn" title="Selecting the Sync Reset button resets linksync to update all WooCommerce products with data from Vend, based on your existing Product Sync Settings."  value="Sync Reset" id="sync_reset_btn_id" class="button button-primary" style="display:<?php
         if (get_option('product_sync_type') == 'wc_to_vend') {
             echo "none";
         }
?>" name="sync_reset"/> 
            <input id="sync_reset_all_btn_id" type="button" title="Selecting this option will sync your entire WooCommerce product catalogue to Vend, based on your existing Product Sync Settings. It takes 3-5 seconds to sync each product, depending on the performance of your server, and your geographic location."  onclick="show_confirm_box();" value="Sync all product to Vend" style="display:<?php
                      if (get_option('product_sync_type') == 'vend_to_wc-way') {
                          echo "none";
                      }
?>" class="button button-primary" />
        ...
        <table class="form-table">
            <tbody>
                <tr valign="top">
                    <th  class="titledesc">Name/Title  <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="When enabled, Product titles will be kept in sync. In WooCommerce this is the product Name and in Vend it's the Product name. "  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a> </th>
                ...
                <tr  valign="top">
                    <th  class="titledesc">Description<a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="When enabled, product descriptions will be kept in sync. "  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a></th>
                    <td class="forminp">
                        <label style="display: inline-block;width: 25em;">
...
?>">
                    <th  class="titledesc">Short Description  <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="When enabled, the product description from Vend will be applied to the Product Short Description in WooCommerce."  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a></th>
                    <td class="forminp">
                ...
                <tr valign="top">
                    ...
                    <td class="forminp forminp-checkbox">
                        ...
                        <br><br> <div style="margin-left: 40px;" ><span  class="ps_price_sub_options"> 
                                <b>WooCommerce price field to sync</b><a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Select which WooCommerce price field you want to sync with Vend sell price."  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a>
                                <br>
                                ...
                                <!--                                <legend  id="ps_pricebook_id" style="display:<?php
                                    //    if (get_option('product_sync_type') == 'two_way' || get_option('product_sync_type') == 'wc_to_vend') {
                                    //   echo "none";
                                    // }
                                        ?>;width: 30em;"><a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Product data is synced to and from WooCommerce and Vend (default)"  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a><b>Price Book</b>
            ...
            <!--                                                <input type = "checkbox" <?php //echo (get_option('ps_wc_to_vend_outlet') == 'on' ? 'checked' : '');
                                        ?> value="on" name="ps_wc_to_vend_outlet" />-->
                                                    <b> Vend Outlet to sync WooCommerce with </b><a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="If you have more than one outlet in your Vend store you have the option of choosing which outlet/s you want to keep product synced with. "  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a> </label>
                                                <?php
                            ...
                            if (get_option('product_sync_type') == 'wc_to_vend' || get_option('product_sync_type') == 'two_way') {
                                echo "none;";
                            }
                                                ...
                                                <!--<input type="checkbox" <?php // echo (get_option('ps_outlet') == 'on' ? 'checked' : '');                                                                                                                                                               ?> value="on" name="ps_outlet" />--> 
                                                    <b>Vend Outlet to sync WooCommerce with</b><a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="If you have more than one outlet in your Vend store you have the option of choosing which outlet/s you want to keep product synced with. "  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a>
                                                </label>
                                                <?php
                                                echo'<span style=' . $margin . $dispaynone . '>';
                                                foreach ($outlets['outlets'] as $outlet):
                ...
                <?php if (in_array('woocommerce-brands/woocommerce-brands.php', apply_filters('active_plugins', get_option('active_plugins')))) {
                    ...
                    <tr valign="top" class="woocommerce_frontend_css_colors">
                        <th scope="row" class="titledesc">Brand<a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Enable this option to keep the Brand fields in sync between WooCommerce and Vend."  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a></th>
                        <td class="forminp">
                            <label style="display: inline-block;width: 25em;">
                ...
                <tr valign="top" class="woocommerce_frontend_css_colors">
                    <th scope="row" class="titledesc">Tags  <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="When enabled, product tags will be kept in sync. If you use tags for the Categories , or for the Import by tag options below, then you may opt not to enable this option as you might have tags you don't want displayed to visitors of your store. "  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a> </th>
                    <td class="forminp">
                        <label style="display: inline-block;width: 25em;">
                            <input type="checkbox" <?php echo (get_option('ps_tags') == 'on' ? 'checked' : ''); ?> value="on" name="ps_tags" />Sync tags between apps</label>
                    </td>
                </tr>
                <tr style="display:<?php echo (get_option('product_sync_type') == 'wc_to_vend' ? 'none' : ''); ?>" id="ps_cat_id_p" valign="top" class="woocommerce_frontend_css_colors">
                    <th scope="row" class="titledesc">Categories   <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-right: 10px" title="Enabling this option will allow you to sync products from Vend to categories in WooCommerce by Vend Tags or by Product Types"  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a></th>
                    <td class="forminp">
                        <!--aman changes-->
                        ...
                        <div class="ps_categories" style="margin-left:45px"><label class="ps_categories" style="display: inline-block;width: 10em; " ><input type="radio" name="cat_radio"  <?php echo (get_option('cat_radio') == 'ps_cat_tags' ? 'checked' : ''); ?>  value="ps_cat_tags">Tags<a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Vend tags are mapped to existing categories in WooCommerce &#45; if no category has been set up in WooCommerce, tags will not be mapped. Subcategories are recognised when the different paths are separated by &quot; / &quot; (space/space).  "  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a></label>
                            <br><br> <label class="ps_categories" style="display: inline-block;width: 10em; " ><input type="radio" name="cat_radio" <?php echo (get_option('cat_radio') == 'ps_cat_product_type' ? 'checked' : ''); ?>  value="ps_cat_product_type">Product Types<a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Vend product types are mapped to existing categories in WooCommerce &#45; if no category has been set up in WooCommerce, product types will not be mapped."  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a> </label></div>
                    </td> 
                </tr>
                <tr style="display:<?php echo (get_option('product_sync_type') == 'wc_to_vend' ? 'none' : ''); ?>" id="ps_pending" valign="top" class="woocommerce_frontend_css_colors">
                    <th scope="row" class="titledesc">Product Status <a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-right: 10px" title="Enable this option if you want newly created product in Vend to be set to 'Pending Review' so that you can review and update new product before they are published in your WooCommerce store."  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a></th>
                ...
                <tr style="display:<?php echo (get_option('product_sync_type') == 'wc_to_vend' ? 'none' : ''); ?>" id="ps_import_image_id" valign="top" class="woocommerce_frontend_css_colors">
                    <th scope="row" class="titledesc">Images<a href="https://www.linksync.com/help/woocommerce"><img style="margin-bottom:-4px;margin-left:4px" title="Select this option to have product images in Vend synced to products in WooCommerce."  src="../wp-content/plugins/linksync/img/help.png" height="16" width="16"></a></th>
                    <td class="forminp">
                        <!--aman changes-->
...
<style> 
    ...
    <div id="please-wait" class="loader-please-wait" style="display: none;">
        ...
        <script type="text/javascript"> 
            linksynProduct_jquery(".outlets_check").change(function(){
                if (linksynProduct_jquery('.outlets_check:checked').length ==0) {
                    linksynProduct_jquery("#check_outlets").show(); 
                    linksynProduct_jquery("#check_outlets").html('You didn\'t select any outlet !'); 
                    return false;
                }else{ 
                    linksynProduct_jquery("#check_outlets").hide();
                    return true;
                } 
            });
            function  show_confirm_box() { 
                if(linksynProduct_jquery("#pop_up_syncll").is(":visible")==false && linksynProduct_jquery("#pop_up_two-way").is(":visible")==false && linksynProduct_jquery("#pop_up").is(":visible")==false){
                    linksynProduct_jquery(document).ready(function() {
                        ...
                        linksynProduct_jquery('#sync_start_export').show();
                        linksynProduct_jquery("#sync_start_export").html('Do you want to sync all product to Vend?'); 
...
<?php update_option('post_product', 0); ?>
    ...
    function ajaxRequestForproduct(i,totalreq){ 
        var ajaxobj= linksynProduct_jquery.ajax({
            ...
            url: '../wp-content/plugins/linksync/sync_all_product_to_vend.php',
    ...
    function sync_process_start() { 
        ...
        linksynProduct_jquery('#syncing_loader1').css("display", "block");
        linksynProduct_jquery('#sync_start_export1').show();
    ...
    linksynProduct_jquery(document).ready(function() {
        linksynProduct_jquery("input[name='product_sync_type']").click(function() {
            ...
            if (linksynProduct_jquery("input[value='vend_to_wc-way']").is(":checked")) {
            ...
            if (linksynProduct_jquery("input[value='wc_to_vend']").is(":checked")) {
                linksynProduct_jquery('#sync_reset_btn_id').hide(500);
                linksynProduct_jquery('#short_description').hide(500);
                ...
                linksynProduct_jquery('#short_description').show(500);
            ...
            if(linksynProduct_jquery("#ps_quantity").is(":checked")){ 
                if (linksynProduct_jquery("input[value='two_way']").is(":checked")||linksynProduct_jquery("input[value='wc_to_vend']").is(":checked")){
                    ...
                    linksynProduct_jquery("#wctovend_outlet").fadeIn(500);
                }else if (linksynProduct_jquery("input[value='vend_to_wc-way']").is(":checked")) {
                    linksynProduct_jquery("#unpublish_stock_id").fadeIn(500); 
                    linksynProduct_jquery("#outlet").fadeIn(500);
                    linksynProduct_jquery("#wctovend_outlet").fadeOut(500);
                }
            }else{ 
                linksynProduct_jquery("#unpublish_stock_id").fadeOut(500); 
                linksynProduct_jquery("#outlet").fadeOut(500);
                linksynProduct_jquery("#wctovend_outlet").fadeOut(500); 
            }
            if (linksynProduct_jquery("input[value='two_way']").is(":checked") || linksynProduct_jquery("input[value='wc_to_vend']").is(":checked")) {
                linksynProduct_jquery('#ps_pricebook_id').fadeOut(500); 
                linksynProduct_jquery('#product_attribute').fadeOut(500);  
            } else {
                linksynProduct_jquery('#ps_pricebook_id').fadeIn(500);
                linksynProduct_jquery('#product_attribute').fadeIn(500);  
            }
            if (linksynProduct_jquery("input[value='wc_to_vend']").is(":checked")) {
                linksynProduct_jquery("#wc_to_vend_outlet").fadeIn(500);
                linksynProduct_jquery("#vend-to-wc_outlet").fadeOut(500); 
            } else if (linksynProduct_jquery("input[value='vend_to_wc-way']").is(":checked")) {
                if (linksynProduct_jquery('.outlets_check:checked').length ==0) { 
                    linksynProduct_jquery("#check_outlets").show(); 
                    linksynProduct_jquery("#check_outlets").html('You didn\'t select any outlet !');
                }
                linksynProduct_jquery("#wc_to_vend_outlet").fadeOut(500);
                linksynProduct_jquery("#vend-to-wc_outlet").fadeIn(500); 
        ...
        if (linksynProduct_jquery("input[name='ps_description']").is(":checked")) {
            linksynProduct_jquery("#ps_desc_span").fadeIn(500);
        }

        linksynProduct_jquery("input[name='ps_description']").click(function() {
            if (linksynProduct_jquery("input[name='ps_description']").is(":checked")) {
                linksynProduct_jquery("#ps_desc_span").fadeIn(500);
            } else {
                linksynProduct_jquery("#ps_desc_span").fadeOut(500);
            }
        });
        ...
        linksynProduct_jquery("input[name='ps_wc_to_vend_outlet']").click(function() {
            if (linksynProduct_jquery("input[name='ps_wc_to_vend_outlet']").is(":checked")) {
                linksynProduct_jquery("#wc_to_vend_outlet").fadeIn(500);
            } else {
                linksynProduct_jquery("#wc_to_vend_outlet").fadeOut(500);
            }
        });
        if (linksynProduct_jquery("input[name='ps_categories']").is(":checked")) {
            linksynProduct_jquery(".ps_categories").fadeIn(500);
        } else {
            linksynProduct_jquery(".ps_categories").fadeOut(500);
        }
        linksynProduct_jquery("input[name='ps_categories']").click(function() {
            if (linksynProduct_jquery("input[name='ps_categories']").is(":checked")) {
                linksynProduct_jquery(".ps_categories").fadeIn(500);
            } else {
                linksynProduct_jquery(".ps_categories").fadeOut(500);
        ...
        if (linksynProduct_jquery("input[name='ps_images']").is(":checked")) {
            linksynProduct_jquery(".ps_images").fadeIn(500);
        } else {
            linksynProduct_jquery(".ps_images").fadeOut(500);
        }
        linksynProduct_jquery("input[name='ps_images']").click(function() {
            if (linksynProduct_jquery("input[name='ps_images']").is(":checked")) {
                linksynProduct_jquery(".ps_images").fadeIn(500);
            } else {
                linksynProduct_jquery(".ps_images").fadeOut(500);
    ...
    linksynProduct_jquery(document).on("click","a[name='lnkViews']", function (e) {
...
?>
        ...
        var ajaxupdate=linksynProduct_jquery.ajax({
            ...
            success:function(dataupper){
                if(dataupper.message!=''){
                    ...
                    linksynProduct_jquery("#please-wait").css("display", "block");
                    importProduct();
                }
            },
            error: function(xhr, status, error) {  
                ...
                if(check_error==10){
                    check_error =0; 
                    ajaxupdate.abort();
                    linksynProduct_jquery("#sync_start").html("<p style='font-size:15px;color:red'><b>Internal Connection Error : Please refresh and try again</b>");  
                    linksynProduct_jquery('#syncing_loader1').css('display','none');
                    linksynProduct_jquery('#syncing_loader').css('display','none');
                    linksynProduct_jquery('#syncing_loader_all').css('display','none'); 
                    linksynProduct_jquery('#syncing_close').css('display','block');
                }else{
                    importProduct(); 
                }
                check_error++;
    ...
    function ajaxRequestForproduct_image(i,totalreq,total_product,product_count,status){ 
        linksynProduct_jquery("#sync_start").html("linksync update is running.<br> Importing from product <b>"+ (product_count + 1) +" of "+total_product+"</b>");
        var ajaxobj= linksynProduct_jquery.ajax({
            type: "POST",  
            dataType:'json',
